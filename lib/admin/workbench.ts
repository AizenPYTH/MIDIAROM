...
/**
 * Les quatre registres de l'écran de travail.
 *
 * La base connaît vingt-deux statuts ; le réparateur en lit quatre. Le
 ...
 */
export type Registre = "diag" | "attente" | "atelier" | "prete";
...
export const ORDRE: Registre[] = ["diag", "attente", "atelier", "prete"];
