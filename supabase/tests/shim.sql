-- DEV/TEST ONLY — minimal stand-in for the Supabase-managed schemas so the
-- migrations and RLS tests can run on a plain PostgreSQL instance.
-- Never apply this on a real Supabase project.
do $$
begin
