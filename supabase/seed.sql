...
insert into public.site_settings (key, value, description, is_public) values
  ('brand', '{"name":"Atelier Console","tagline":"Réparation de consoles à distance","description":"Atelier spécialisé dans la réparation de consoles de jeux, partout en France.","email":"contact@example.com","phone":"","address_line1":"","postal_code":"","city":"","country":"France","logo_path":null,"hours":"Lundi au vendredi, 9h–18h","siret":"","legal_form":""}', 'Identité de l''entreprise', true),
  ...
  ('shipping_info', '{"intro":"Vous choisissez votre formule de transport lors de la commande.","return_carrier_note":"Le retour est effectué en colis suivi avec assurance selon la formule choisie.","workshop_receiving_name":"Atelier Console — Service réparation","workshop_receiving_address":"Adresse communiquée après paiement"}', 'Informations transport', true),
...
insert into public.content_blocks (key, title, body, data) values
  ('homepage.hero', 'Faites réparer votre console, où que vous soyez en France.', 'Choisissez votre console et votre panne, commandez en ligne et suivez votre réparation de l''envoi jusqu''au retour.', '{"cta_primary":"Faire réparer ma console","cta_secondary":"Comment ça marche ?"}'),
