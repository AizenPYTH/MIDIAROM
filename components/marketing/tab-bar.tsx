...
/**
 * Barre d'onglets basse du téléphone.
 *
 ...
 * au rouge. Fond blanc et filet haut : elle portait un aplat presque noir,
 * hérité d'une charte sombre, qui posait une barre étrangère au bas d'un site
 * blanc.
 *
  ...
  return (
    <>
      ...
      <nav
        ...
        className="safe-bottom fixed inset-x-0 bottom-0 z-30 grid grid-cols-4 border-t border-border-section bg-bg pt-3 lg:hidden"
