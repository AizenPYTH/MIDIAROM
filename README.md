...
Le design (handoff Claude Design « 207 Mediarom ») et sa correspondance avec les pages sont décrits dans [`docs/DESIGN.md`](docs/DESIGN.md) ; le responsive (écrans mobile M1 à M6) dans [`docs/MOBILE.md`](docs/MOBILE.md).
