  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Section title="Informations"><DescriptionList items={[{ label: "Téléphone", value: profile.phone ?? "—" }, { label: "Inscrit le", value: formatDateTime(profile.created_at) }, { label: "Dossiers", value: orders?.length ?? 0 }, { label: "Total commandé", value: formatPrice(total) }, { label: "Opt-in marketing", value: profile.marketing_opt_in ? "Oui" : "Non" }]} /></Section>
